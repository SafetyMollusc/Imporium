...
copyright_text = "\u00A9 2018 Michael Carey"
...
if defined? LAB_CARDS or defined? LAB_TILES
  lab_data = Squib.xlsx file: '.\res\imporium_lab_cards.xlsx'
end

if defined? LAB_CARDS
  Squib::Deck.new width: 1125, height: 1125, cards: lab_data['title'].size, layout: 'layout_lab.yml' do
    ...
    #while $i < $num_cards do
    	...
    	text str: lab_data['recycle'], layout: 'recycle'
    	text str: lab_data['cost'], layout: 'cost'
      text str: copyright_text, layout: 'copyright'
...
if defined? LAB_TILES
  Squib::Deck.new width: 675, height: 675, cards: lab_data['title'].size, layout: 'layout_lab_tile.yml' do
    #$i = 0
    #$num_cards = data['Total_Qty']
    #$num_cards = $num_cards.to_i
    #while $i < $num_cards do
      ...
      text str: lab_data['cost'], layout: 'cost'
      text str: copyright_text, layout: 'copyright'
      save_png prefix: 'lab_tile_'
      save_pdf file: 'imporium_lab_tiles.pdf', trim: 37.5, margin: 75
    #end
  end
end

if defined? RECIPE_CARDS
